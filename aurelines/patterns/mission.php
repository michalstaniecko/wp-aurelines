...
/**
 * Title: Misja
 * Slug: aurelines/mission
 * Categories: aurelines
 * Keywords: mission, misja, wartości
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"backgroundColor":"background-alt","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-background-alt-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--30)" id="misja">
	...
	<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"1.125rem"},"spacing":{"margin":{"bottom":"var:preset|spacing|50"}}},"className":"aurelines-reveal"} -->
	<p class="has-text-align-center aurelines-reveal" style="margin-bottom:var(--wp--preset--spacing--50);font-size:1.125rem">Wierzymy, że akrobatyka powietrzna to coś więcej niż sport — to sposób na życie pełne odwagi, piękna i&nbsp;radości.</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column has-background-background-color has-background aurelines-card aurelines-reveal aurelines-reveal-delay-1" style="border-radius:16px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--30)">
			...
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.9375rem","lineHeight":"1.7"}}} -->
			<p class="has-text-align-center" style="font-size:0.9375rem;line-height:1.7">Kochamy to, co robimy. Każde zajęcia to energia, emocje i&nbsp;radość z&nbsp;ruchu w&nbsp;powietrzu. Naszą pasją zarażamy innych.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column has-background-background-color has-background aurelines-card aurelines-reveal aurelines-reveal-delay-2" style="border-radius:16px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--30)">
			...
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.9375rem","lineHeight":"1.7"}}} -->
			<p class="has-text-align-center" style="font-size:0.9375rem;line-height:1.7">Bezpieczeństwo naszych uczniów jest priorytetem. Profesjonalny sprzęt, certyfikowani instruktorzy i&nbsp;sprawdzone metody treningowe.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column has-background-background-color has-background aurelines-card aurelines-reveal aurelines-reveal-delay-3" style="border-radius:16px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--30)">
			...
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.9375rem","lineHeight":"1.7"}}} -->
			<p class="has-text-align-center" style="font-size:0.9375rem;line-height:1.7">Wspieramy Cię na każdym etapie — od pierwszych kroków po zaawansowane figury. Twój rozwój jest naszym sukcesem.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
